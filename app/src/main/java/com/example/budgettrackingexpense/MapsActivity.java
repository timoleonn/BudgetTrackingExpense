...
public class MapsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] placeTypeList = {"Bank of Cyprus", "AstroBank", "Alpha Bank", "Hellenic Bank", "Rcb Bank"};
        String[] placeNameList = {"Bank of Cyprus", "AstroBank", "Alpha Bank", "Hellenic Bank", "Rcb Bank"};
